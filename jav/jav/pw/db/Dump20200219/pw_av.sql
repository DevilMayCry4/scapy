...
CREATE TABLE `av` (
  ...
  `genreName` varchar(500) DEFAULT NULL,
  `genre` varchar(500) DEFAULT NULL,
  `star` varchar(500) DEFAULT NULL,
  `starName` varchar(500) DEFAULT NULL,
  `number` varchar(500) DEFAULT NULL,
  `studio` varchar(500) DEFAULT NULL,
  `series` varchar(500) DEFAULT NULL,
  `seriesName` varchar(500) DEFAULT NULL,
...
-- Dump completed on 2020-02-19 17:31:09
